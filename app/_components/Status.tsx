            ...
            <div className="flex-[2] w-full flex flex-col gap-4">
                ...
                <Card className="p-4 flex-1">
                    ...
                    <Link href = "https://www.linkedin.com/in/masooma-mukhtar/">
                        <ContactCard name="LinkedIn" image="https://massooma.github.io/Portfolio/images/Mukhtar_Masooma_Photo.jpg" mediumImage="https://logospng.org/download/linkedin/logo-linkedin-icon-1536.png" description="Dm me!"/>
                    </Link>
                    <Link href = "mailto:mukhtar.masooma@gmail.com">
                        <ContactCard name="E-mail" image="https://massooma.github.io/Portfolio/images/MUKHTAR_Masooma_Photo_2.png" mediumImage="https://download.logo.wine/logo/Gmail/Gmail-Logo.wine.png" description="Send me an email!"/>
                    </Link>
                </Card>
            </div>
        </Section>
